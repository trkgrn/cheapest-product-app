package com.trkgrn_theomer.cheapspring.api.exception;
...
public class GeneralExceptionHandler {
    ...
    @ExceptionHandler(value = { com.trkgrn_theomer.cheapspring.api.exception.NullPointerExc.class })
    public ResponseEntity<Object> handleNullPointerException(com.trkgrn_theomer.cheapspring.api.exception.NullPointerExc ex) {
    ...
    @ExceptionHandler(value = { com.trkgrn_theomer.cheapspring.api.exception.SQLExc.class })
    public ResponseEntity<Object> handleSQLException(com.trkgrn_theomer.cheapspring.api.exception.SQLExc ex) {
