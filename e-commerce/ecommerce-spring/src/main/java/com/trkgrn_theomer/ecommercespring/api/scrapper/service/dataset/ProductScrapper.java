package com.trkgrn_theomer.ecommercespring.api.scrapper.service.dataset;
...
public class ProductScrapper {
    ...
    public ProductScrapper(ProductService productService) {
    ...
    private List<Product> getProducts(int page) throws IOException {
        ...
        for (Element e : body.select("div.product-list--list-page")) {
            ...
            if (priceDbl<15000)
                priceDbl = priceDbl + (priceDbl*0.05);
            else
                priceDbl = priceDbl - (priceDbl*0.05);
            ...
            product.setProductPrice(priceDbl);
